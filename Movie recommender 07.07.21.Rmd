...
#library(proxy)
sim_results<- proxy::dist(sim_mx, method= "Jaccard") #Let's calculate the binary distance.

sim_results<-as.data.frame(as.matrix(sim_results))
sim_results<-sim_results[-1,1] #similarity of column 1, withouth row 1. column 1 is our user against all movies, and roow 1 is also our user.
